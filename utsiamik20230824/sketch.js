...
// }
//import uhuanikData from "./kilok.json";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  saveBtn.addEventListener("click", function () {
    for (let i = 1; i <= uhuanikData.length; i++) {
      const tholunInput = document.getElementById(i).value;
      uhuanikData[i - 1].tholunInput = tholunInput;
    }

    const jsonStr = JSON.stringify(uhuanikData, null, 2);
